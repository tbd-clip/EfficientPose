...
class Generator(keras.utils.Sequence):
    ...
    def __init__(
            ...
            points_for_shape_match_loss = 8, #500,
            batch_size = 1,
        ...
        avg_bcube = np.expand_dims(avg_bcube, axis=0)
        assert avg_bcube.shape == (1, 8, 3), "oh nein! " + str(avg_bcube.shape)
    ...
    def augment_6DoF_image_and_annotations(self, img, annotations, camera_matrix):
        ...
        for i in range(num_annos):
            ...
            bbox_annos[i, :] = annotations["bboxes"][i, :]
